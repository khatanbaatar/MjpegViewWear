...
public class SettingsActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        skipText = (TextView) this.findViewById(R.id.skip_val);
        skipSeek = (SeekBar) this.findViewById(R.id.skip_seek);
        ...
        if (extras != null) {
            ...
            frameSkip = extras.getInt("frameSkip", frameSkip);
            ...
            skipText.setText(Integer.toString(frameSkip));
            skipSeek.setProgress(frameSkip - 3);
        }
        ...
        skipSeek.setOnSeekBarChangeListener(
                new SeekBar.OnSeekBarChangeListener() {
                    public void onProgressChanged(SeekBar seekBar, int progress,
                                                  boolean fromUser) {
                        frameSkip = progress + 3;
                        skipText.setText(Integer.toString(frameSkip));
                    }
        ...
        settings_done.setOnClickListener(
                new View.OnClickListener() {
                    public void onClick(View view) {
                        ...
                        frameSkip = skipSeek.getProgress() + 3;
                        ...
                        intent.putExtra("frameSkip", frameSkip);
